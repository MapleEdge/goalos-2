        ...
        {process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID && (
          <>
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-300 bg-white px-4 py-2.5 text-sm font-medium text-zinc-700 hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-zinc-200 transition-colors"
            >
        ...
        <div className="space-y-2 text-center text-sm text-zinc-500">
          ...
          <p>
            <Link
              ...
              className="font-medium text-zinc-500 hover:text-zinc-700 hover:underline"
            >
