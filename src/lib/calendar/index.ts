...
export type { CalendarConnector, CalendarEvent, CalendarListEntry, TokenResult } from "./types";

export function getConnector(provider: "GOOGLE" | "MICROSOFT"): CalendarConnector {
  switch (provider) {
    case "GOOGLE":
